...
df = pd.read_csv('data/luxurylevel.csv')
...
model_df = end_value(data=df, level='luxury')
...
x_train, x_test, y_train, y_test = train_test_split(model_data, model_y, test_size = 0.33, random_state=123)
...
joblib.dump(model, 'model_objects/luxury_model.pkl')
